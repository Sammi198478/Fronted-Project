...
function Carousels() {
  ...
  return (
    ...
    <section className='overflow-hidden p-2'>
        <h1 className='text-center text-2xl lg:text-4xl text-[#26395C] mt-24 mb-12 font-semibold'>See How People are Chilling On Chillsbay</h1>
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex flex-col lg:flex-row items-center gap-6  w-full px-12'>
                    <div className='w-full lg:w-1/2'>
                        <h3 className='text-2xl font-semibold lg:ms-10 text-[#26395C] text-center lg:text-start'>Upcoming events this weekend</h3>
